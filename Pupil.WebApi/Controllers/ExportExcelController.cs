...
namespace Pupil.WebApi.Controllers
{
    ...
    public class ExportExcelController : ControllerBase
    {
        ...
        public ExportExcelController(IParentService parentService,IGradeService gradeService,IDivisionService divisionService)
        {
        ...
        public async Task<IActionResult> WriteDataToExcel()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                //Grades
                worksheet.Range("D2:D500").SetDataValidation().IgnoreBlanks = true;
                worksheet.Range("D2:D500").SetDataValidation().InCellDropdown = true;
                worksheet.Range("D2:D500").Value = "---";
                worksheet.Range("D2:D500").SetDataValidation().List(validGradeOptions, true);
                ...
                worksheet.Range("E2:E500").SetDataValidation().List(validDivisionOptions, true);
                ...
                worksheet.Range("F2:F500").SetDataValidation().List(validParentOptions, true);
